...
3. Create a data visualization of some aspect of `penguins` as a figure that is
   ...
   - links to 
4. Create two additional data visualizations and place them side-by-side on the same line of the output document. This is similar to how you laid out your figures in exercise three but passes many of those same options via the hashpipe. Please:
   - add captions to each subfigure and caption to the whole figure.
